...
if ($exclusions == "true") {
	...
	<table class=TBscore>
	  <tr>
	    <th class=names width=300><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Client Name\">Client Name</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Antivirus\">Antivirus</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Disk\">Disk</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Intrusion\">Intrusion</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Usability\">Usability</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Services\">Services</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Updates\">Updates</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Events\">Events</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&exclusions=true&sorting=".$sort."&field=Overall Score\">Overall Score</a></th>
	  </tr>";
	  } else {
	echo "<p><hr align=center width=75%><p><h2><b>{$net_sp} Team Health Scores{$exclusions_text}</b></h2>
	<table class=TBscore>
	  <tr>
	    <th class=names width=300><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Client Name\">Client Name</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Antivirus\">Antivirus</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Disk\">Disk</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Intrusion\">Intrusion</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Usability\">Usability</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Services\">Services</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Updates\">Updates</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Events\">Events</a></th>
		<th class=stats><a href=\"../php/ns_score.php?net_sp={$net_sp}&sorting=".$sort."&field=Overall Score\">Overall Score</a></th>
	  </tr>";
	  }
...
?>
	  <p><br><h3><strong>Disclaimer:</strong></h3>
		<table class=score_explain>
		  <tr align=left>
			<td style='text-align:left;'><ul style="list-style-type:disc"><li>Health scores are calculated and updated daily at 7:00AM Central Time.</li>
