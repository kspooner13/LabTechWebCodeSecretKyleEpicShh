$(function() {
    ...
    $('.rm-mustard').on("click",function() {
        $('.refresh-example').find('[value=Mustard]').remove();
        $('.refresh-example').selectpicker('refresh');
    });
    $('.rm-ketchup').on("click",function() {
        $('.refresh-example').find('[value=Ketchup]').remove();
        $('.refresh-example').selectpicker('refresh');
    });
    ...
    $('#set-single-value').on('click', function() {
        $('.set-single-value').selectpicker('val', 'Mustard');
    });

    // Multiple values method
    $('#set-multiple-values').on('click', function() {
        $('.set-multiple-values').selectpicker('val', ['Mustard','Ketchup']);
    });
