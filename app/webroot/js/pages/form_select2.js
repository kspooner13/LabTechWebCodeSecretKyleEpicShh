$(function() {						
	...
	$('.select-results-color').select2({
		containerCssClass: 'bg-slate-400'
	});

	// Custom menu color
	$('.select-menu-color').select2({
		dropdownCssClass: 'bg-slate-800'
	});

	// Custom menu and results color
	$('.select-custom-colors').select2({
		containerCssClass: 'bg-blue-800',
		dropdownCssClass: 'bg-blue-800'
	});
	...
	// ------------------------------
	// XLarge
	$('.select-size-xlg').select2({
		containerCssClass: 'select-xlg'
	});
