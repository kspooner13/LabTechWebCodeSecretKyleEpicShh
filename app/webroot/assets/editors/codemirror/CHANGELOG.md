...
Add the [mbox mode](http://codemirror.net/mode/mbox/index.phpl) to `mode/meta.js`.
...
[Python mode](http://codemirror.net/mode/python/index.phpl): Improve distinguishing of decorators from `@` operators.
...
[PowerShell mode](http://codemirror.net/mode/powershell/index.phpl): Added.

[Yacas mode](http://codemirror.net/mode/yacas/index.phpl): Added.

[Web IDL mode](http://codemirror.net/mode/webidl/index.phpl): Added.

[SAS mode](http://codemirror.net/mode/sas/index.phpl): Added.

[mbox mode](http://codemirror.net/mode/mbox/index.phpl): Added.
...
[protobuf mode](http://codemirror.net/mode/protobuf/index.phpl): Newly added.
...
[clike mode](http://codemirror.net/mode/clike/index.phpl): No longer gets confused when a comment starts after an operator.

[markdown mode](http://codemirror.net/mode/markdown/index.phpl): Now supports CommonMark-style flexible list indentation.

[dylan mode](http://codemirror.net/mode/dylan/index.phpl): Several improvements and fixes.
...
* New modes: [JSX](http://codemirror.net/mode/jsx/index.phpl), [literate Haskell](http://codemirror.net/mode/haskell-literate/index.phpl)
...
* The [Swift](http://codemirror.net/mode/swift/index.phpl) mode now supports auto-indentation
* Frontmatters in the [YAML frontmatter](http://codemirror.net/mode/yaml-frontmatter/index.phpl) mode are now optional as intended
...
* The [Swift mode](http://codemirror.net/mode/swift/index.phpl) was rewritten.
...
* New mode: [Crystal](http://codemirror.net/mode/crystal/index.phpl).
...
* New modes: [NSIS](http://codemirror.net/mode/nsis/index.phpl), [Ceylon](http://codemirror.net/mode/clike/index.phpl)
* The Kotlin mode is now a [clike](http://codemirror.net/mode/clike/index.phpl) dialect, rather than a stand-alone mode
...
* New modes: [Vue](http://codemirror.net/mode/vue/index.phpl), [Oz](http://codemirror.net/mode/oz/index.phpl), [MscGen](http://codemirror.net/mode/mscgen/index.phpl) (and dialects), [Closure Stylesheets](http://codemirror.net/mode/css/gss.html)
* Implement [CommonMark](http://commonmark.org)-style flexible list indent and cross-line code spans in [Markdown](http://codemirror.net/mode/markdown/index.phpl) mode
...
* Handle `acync`/`await` and ocal and binary numbers in [JavaScript mode](http://codemirror.net/mode/javascript/index.phpl)
* Fix various issues with the [Haxe mode](http://codemirror.net/mode/haxe/index.phpl)
...
* Tokenize properties as properties in the [CoffeeScript mode](http://codemirror.net/mode/coffeescript/index.phpl)
...
* The [Rust mode](http://codemirror.net/mode/rust/index.phpl) was rewritten to handle modern Rust
...
*   New modes: [Brainfuck](http://codemirror.net/mode/brainfuck/index.phpl), [VHDL](http://codemirror.net/mode/vhdl/index.phpl), Squirrel ([clike](http://codemirror.net/mode/clike/index.phpl) dialect)
...
*   New modes: [Twig](http://codemirror.net/mode/twig/index.phpl), [Elm](http://codemirror.net/mode/elm/index.phpl), [Factor](http://codemirror.net/mode/factor/index.phpl), [Swift](http://codemirror.net/mode/swift/index.phpl)
*   Prefer clipboard API (if available) when pasting
*   Refined definition highlighting in [clike](http://codemirror.net/mode/clike/index.phpl) mode
...
*   New modes: [ASN.1](http://codemirror.net/mode/asn.1/index.phpl), [TTCN](http://codemirror.net/mode/ttcn/index.phpl), and [TTCN-CFG](http://codemirror.net/mode/ttcn-cfg/index.phpl)
*   The [clike](http://codemirror.net/mode/clike/index.phpl) mode can now deep-indent `switch` statements, and roughly recognizes types and defined identifiers
...
*   New modes: [MUMPS](http://codemirror.net/mode/mumps/index.phpl), [Handlebars](http://codemirror.net/mode/handlebars/index.phpl)
*   Rewritten modes: [Django](http://codemirror.net/mode/django/index.phpl), [Z80](http://codemirror.net/mode/z80/index.phpl)
...
*   New modes: [ASCII armor](http://codemirror.net/mode/asciiarmor/index.phpl) (PGP data), [Troff](http://codemirror.net/mode/troff/index.phpl), and [CMake](http://codemirror.net/mode/cmake/index.phpl).
*   Remove SmartyMixed mode, rewrite [Smarty](http://codemirror.net/mode/smarty/index.phpl) mode to supersede it.
...
*   New modes: [Forth](http://codemirror.net/mode/forth/index.phpl), [Stylus](http://codemirror.net/mode/stylus/index.phpl).
*   Make the [CSS mode](http://codemirror.net/mode/css/index.phpl) understand some modern CSS extensions.
*   Have the [Scala mode](http://codemirror.net/mode/clike/index.phpl) handle symbols and triple-quoted strings.
...
*   Improvements to the [Sass mode](http://codemirror.net/mode/sass/index.phpl)'s indentation.
...
*   New modes: [Dart](http://codemirror.net/mode/dart/index.phpl), [EBNF](http://codemirror.net/mode/ebnf/index.phpl), [spreadsheet](http://codemirror.net/mode/spreadsheet/index.phpl), and [Soy](http://codemirror.net/mode/soy/index.phpl).
...
*   New modes: [dockerfile](http://codemirror.net/mode/dockerfile/index.phpl), [IDL](http://codemirror.net/mode/idl/index.phpl), [Objective C](http://codemirror.net/mode/clike/index.phpl) (crude).
...
*   Improvements to modes: [gfm](http://codemirror.net/mode/gfm/index.phpl) (strikethrough), [SPARQL](http://codemirror.net/mode/sparql/index.phpl) (version 1.1 support), and [sTeX](http://codemirror.net/mode/stex/index.phpl) (no more runaway math mode).
...
*   More mode improvements: [CoffeeScript](http://codemirror.net/mode/coffeescript/index.phpl) (indentation), [Verilog](http://codemirror.net/mode/verilog/index.phpl) (indentation), [Scala](http://codemirror.net/mode/clike/index.phpl) (indentation, triple-quoted strings), and [PHP](http://codemirror.net/mode/php/index.phpl) (interpolated variables in heredoc strings).
*   New modes: [Textile](http://codemirror.net/mode/textile/index.phpl) and [Tornado templates](http://codemirror.net/mode/tornado/index.phpl).
...
*   New mode: [Modelica](http://codemirror.net/mode/modelica/index.phpl)
...
*   New mode: [Slim](http://codemirror.net/mode/slim/index.phpl)
...
*   New mode: [Kotlin](http://codemirror.net/mode/kotlin/index.phpl)
...
*   Rewritten [Jade](http://codemirror.net/mode/jade/index.phpl) mode.
*   Various improvements to [Shell](http://codemirror.net/mode/shell/index.phpl) (support for more syntax) and [Python](http://codemirror.net/mode/python/index.phpl) (better indentation) modes.
*   New mode: [Cypher](http://codemirror.net/mode/cypher/index.phpl).
...
*   New mode: [Django](http://codemirror.net/mode/django/index.phpl).
*   Improved modes: [Verilog](http://codemirror.net/mode/verilog/index.phpl) (rewritten), [Jinja2](http://codemirror.net/mode/jinja2/index.phpl), [Haxe](http://codemirror.net/mode/haxe/index.phpl), [PHP](http://codemirror.net/mode/php/index.phpl) (string interpolation highlighted), [JavaScript](http://codemirror.net/mode/javascript/index.phpl) (indentation of trailing else, template strings), [LiveScript](http://codemirror.net/mode/livescript/index.phpl) (multi-line strings).
...
*   In the [XML mode](http://codemirror.net/mode/xml/index.phpl), add `brackets` style to angle brackets, fix case-sensitivity of tags for HTML.
*   New mode: [Dylan](http://codemirror.net/mode/dylan/index.phpl).
...
*   New mode: [Solr](http://codemirror.net/mode/solr/index.phpl).
...
*   The [XML](http://codemirror.net/mode/xml/index.phpl) and [CSS](http://codemirror.net/mode/css/index.phpl) modes were largely rewritten. [LESS](http://codemirror.net/mode/css/less.html) support was added to the CSS mode.
*   The OCaml mode was moved to an [mllike](http://codemirror.net/mode/mllike/index.phpl) mode, F# support added.
...
*   Better ECMAScript 6 support in [JavaScript](http://codemirror.net/mode/javascript/index.phpl) mode.
*   Full [list of patches](https://github.com/codemirror/CodeMirror/compare/3.20.0...3.21.0).

## 3.20.0 (2013-11-21)

*   New modes: [Julia](http://codemirror.net/mode/julia/index.phpl) and [PEG.js](http://codemirror.net/mode/pegjs/index.phpl).
*   Support ECMAScript 6 in the [JavaScript mode](http://codemirror.net/mode/javascript/index.phpl).
*   Improved indentation for the [CoffeeScript mode](http://codemirror.net/mode/coffeescript/index.phpl).
...
*   New modes: [Eiffel](http://codemirror.net/mode/eiffel/index.phpl), [Gherkin](http://codemirror.net/mode/gherkin/index.phpl), [MSSQL dialect](http://codemirror.net/mode/sql/?mime=text/x-mssql).
...
*   New modes: [Fortran](http://codemirror.net/mode/fortran/index.phpl), [Octave](http://codemirror.net/mode/octave/index.phpl) (Matlab), [TOML](http://codemirror.net/mode/toml/index.phpl), and [DTD](http://codemirror.net/mode/dtd/index.phpl).
...
*   New modes: [Jade](http://codemirror.net/mode/jade/index.phpl), [Nginx](http://codemirror.net/mode/nginx/index.phpl).
...
*   Various improvements to [Ruby](http://codemirror.net/mode/ruby/index.phpl), [Smarty](http://codemirror.net/mode/smarty/index.phpl), [SQL](http://codemirror.net/mode/sql/index.phpl), and [Vim](http://codemirror.net/demo/vim.html) modes.
*   Full [list of patches](https://github.com/codemirror/CodeMirror/compare/3.13.0...3.14.0).

## 3.13.0 (2013-05-20)

*   New modes: [COBOL](http://codemirror.net/mode/cobol/index.phpl) and [HAML](http://codemirror.net/mode/haml/index.phpl).
...
*   New mode: [GNU assembler](http://codemirror.net/mode/gas/index.phpl).
...
*   **Removed code:** `collapserange`, `formatting`, and `simple-hint` addons. `plsql` and `mysql` modes (use [`sql`](http://codemirror.net/mode/sql/index.phpl) mode).
...
*   New modes: [SCSS](http://codemirror.net/mode/css/scss.html), [Tcl](http://codemirror.net/mode/tcl/index.phpl), [LiveScript](http://codemirror.net/mode/livescript/index.phpl), and [mIRC](http://codemirror.net/mode/mirc/index.phpl).
...
*   New modes: [D](http://codemirror.net/mode/d/index.phpl), [Sass](http://codemirror.net/mode/sass/index.phpl), [APL](http://codemirror.net/mode/apl/index.phpl), [SQL](http://codemirror.net/mode/sql/index.phpl) (configurable), and [Asterisk](http://codemirror.net/mode/asterisk/index.phpl).
...
*   Extend [htmlmixed mode](http://codemirror.net/mode/htmlmixed/index.phpl) to allow custom handling of script types.
...
*   New modes: [Turtle](http://codemirror.net/mode/turtle/index.phpl) and [Q](http://codemirror.net/mode/q/index.phpl).
*   Further improvements to the [vim mode](http://codemirror.net/demo/vim.html).
...
Integrate some bugfixes, enhancements to the vim keymap, and new modes ([D](http://codemirror.net/mode/d/index.phpl), [Sass](http://codemirror.net/mode/sass/index.phpl), [APL](http://codemirror.net/mode/apl/index.phpl)) from the v3 branch.

## 2.37.0 (2012-12-20)

*   New mode: [SQL](http://codemirror.net/mode/sql/index.phpl) (will replace [plsql](http://codemirror.net/mode/plsql/index.phpl) and [mysql](http://codemirror.net/mode/mysql/index.phpl) modes).
...
*   New mode: [Z80 assembly](http://codemirror.net/mode/z80/index.phpl).
...
*   Make [PHP mode](http://codemirror.net/mode/php/index.phpl) build on [mixed HTML mode](http://codemirror.net/mode/htmlmixed/index.phpl).
...
*   New mode: [Common Lisp](http://codemirror.net/mode/commonlisp/index.phpl).
...
*   New mode: [Sieve](http://codemirror.net/mode/sieve/index.phpl).
...
*   New modes: [OCaml](http://codemirror.net/mode/ocaml/index.phpl), [Haxe](http://codemirror.net/mode/haxe/index.phpl), and [VB.NET](http://codemirror.net/mode/vb/index.phpl).
...
*   New mode: [Erlang](http://codemirror.net/mode/erlang/index.phpl).
*   **Remove xmlpure mode** (use [xml.js](http://codemirror.net/mode/xml/index.phpl)).
...
*   New modes: [Shell](http://codemirror.net/mode/shell/index.phpl), [Tiki wiki](http://codemirror.net/mode/tiki/index.phpl), [Pig Latin](http://codemirror.net/mode/pig/index.phpl).
...
*   New modes: [XQuery](http://codemirror.net/mode/xquery/index.phpl) and [VBScript](http://codemirror.net/mode/vbscript/index.phpl).
*   Two new themes: [lesser-dark](http://codemirror.net/mode/less/index.phpl) and [xq-dark](http://codemirror.net/mode/xquery/index.phpl).
...
*   New [.properties](http://codemirror.net/mode/properties/index.phpl) mode.
*   Fix many bugs.

## 2.21.0 (2012-01-27)

*   Added [LESS](http://codemirror.net/mode/less/index.phpl), [MySQL](http://codemirror.net/mode/mysql/index.phpl), [Go](http://codemirror.net/mode/go/index.phpl), and [Verilog](http://codemirror.net/mode/verilog/index.phpl) modes.
...
*   Add [Github-style Markdown](http://codemirror.net/mode/gfm/index.phpl) mode.
...
*   Add [Perl](http://codemirror.net/mode/perl/index.phpl), [Rust](http://codemirror.net/mode/rust/index.phpl), [TiddlyWiki](http://codemirror.net/mode/tiddlywiki/index.phpl), and [Groovy](http://codemirror.net/mode/groovy/index.phpl) modes.
...
*   Add [Clojure](http://codemirror.net/mode/clojure/index.phpl), [Pascal](http://codemirror.net/mode/pascal/index.phpl), [NTriples](http://codemirror.net/mode/ntriples/index.phpl), [Jinja2](http://codemirror.net/mode/jinja2/index.phpl), and [Markdown](http://codemirror.net/mode/markdown/index.phpl) modes.
...
*   Add [Ruby](http://codemirror.net/mode/ruby/index.phpl), [R](http://codemirror.net/mode/r/index.phpl), [CoffeeScript](http://codemirror.net/mode/coffeescript/index.phpl), and [Velocity](http://codemirror.net/mode/velocity/index.phpl) modes.
...
*   Add an experimental [pure XML](http://codemirror.net/mode/xmlpure/index.phpl) mode.

## 2.12.0 (2011-07-25)

*   Add a [SPARQL](http://codemirror.net/mode/sparql/index.phpl) mode.
...
*   Add a [Scheme mode](http://codemirror.net/mode/scheme/index.phpl).
*   Add a `replace` method to search cursors, for cursor-preserving replacements.
*   Make the [C-like mode](http://codemirror.net/mode/clike/index.phpl) mode more customizable.
*   Update XML mode to spot mismatched tags.
*   Add `getStateAfter` API and `compareState` mode API methods for finer-grained mode magic.
*   Add a `getScrollerElement` API method to manipulate the scrolling DIV.
*   Fix drag-and-drop for Firefox.
*   Add a C# configuration for the [C-like mode](http://codemirror.net/mode/clike/index.phpl).
...
*   Add a [Lua mode](http://codemirror.net/mode/lua/index.phpl).
...
*   Add a [Smalltalk mode](http://codemirror.net/mode/smalltalk/index.phpl).
*   Add a [reStructuredText mode](http://codemirror.net/mode/rst/index.phpl).
*   Add a [Python mode](http://codemirror.net/mode/python/index.phpl).
*   Add a [PL/SQL mode](http://codemirror.net/mode/plsql/index.phpl).
