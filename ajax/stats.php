...
// Run Queries
	...
	$resultPatch = mysql_query($sqlPatch);
	$resultCommand = mysql_query($sqlCommand);
	$resultScript = mysql_query($sqlScript);
...
// Table Script, Patching, Commands Count
    ...
    while ($row = mysql_fetch_array($resultPatch)) {
        echo "<tr>
	...
	while ($row = mysql_fetch_array($resultCommand)) {
        echo "<tr>
	...
	while ($row = mysql_fetch_array($resultScript)) {
        echo "<tr>
...
// Table Tickets
    echo "<h2><b>Ticket Status Summary</b></h2>
	  ...
	  <table class=TBscore padding=5px>
	    <tr align=left>
		  <th width=300 class=names><a href=\"stats.php?sorting=".$sort."&field=Ticket\">Ticket Type</a></th>
		  <th align=center><a href=\"stats.php?sorting=".$sort."&field=New\">New</a></th>
		  <th align=center><a href=\"stats.php?sorting=".$sort."&field=Open\">Open</a></th>
		  <th align=center><a href=\"stats.php?sorting=".$sort."&field=Closed\">Closed</a></th>
		  <th align=center><a href=\"stats.php?sorting=".$sort."&field=Total\">Total</a></th>
		 </tr>";
